...
class LanguageProvider with ChangeNotifier {
  ...
  final Map<String, Map<String, String>> _translations = {
    'en': {
      ...
      'amountTooSmall': 'Amount must be at least 0.01.',
      'supportHelp': 'Help & Support',
      'liveChatSupport': 'Support Chat',
      'contactAdmin': 'Message System Admin',
      'typeMessage': 'Type your message...',
      'supportDescription': 'If you need help or have any questions, you can send a message directly to our admin team.',
      'submitMessage': 'Send Message',
      'messageRequired': 'Please enter a message',
      'supportSubmitted': 'Message sent to admin successfully!',
      'ticketHistory': 'Ticket History',
      'resolved': 'Resolved',
      'adminReply': 'Admin Reply',
      'noSupportTickets': 'No support requests yet.',
    },
    'so': {
      'appTitle': 'MultiBill',
      ...
      'amountTooSmall': 'Qaddarka waa inuu ugu yaraan noqdaa 0.01.',
      'supportHelp': 'Taageerada & Caawinta',
      'liveChatSupport': 'Wadahadalka Taageerada',
      'contactAdmin': 'U dir fariin Maamulaha',
      'typeMessage': 'Qor fariintaada...',
      'supportDescription': 'Hadii aad u baahan tahay caawinaad ama aad qabto su\'aalo, waxaad fariin toos ah u diri kartaa maamulaha.',
      'submitMessage': 'Dir Fariinta',
      'messageRequired': 'Fadlan qor fariintaada',
      'supportSubmitted': 'Fariintaadii si guul ah ayaa loo gaarsiiyey maamulaha!',
      'ticketHistory': 'Fariimihii Hore',
      'resolved': 'La Xaliyey',
      'adminReply': 'Jawaabta Maamulaha',
      'noSupportTickets': 'Weli ma jiraan fariimo caawinaad ah.',
    },
  };
